...
namespace Language_en {
  ...
  LSTR MSG_MAINTENANCE                    = _UxGT("Maintenance");
  LSTR MSG_MAINTENANCE_SERVICE            = _UxGT("Service 100C");
  LSTR MSG_MAINTENANCE_LOAD_200           = _UxGT("Load 200C");
  LSTR MSG_MAINTENANCE_LOAD_220           = _UxGT("Load 220C");
  LSTR MSG_MAINTENANCE_LOAD_240           = _UxGT("Load 240C");
  LSTR MSG_MAINTENANCE_PURGE_200          = _UxGT("Purge 200C");
  LSTR MSG_MAINTENANCE_PURGE_210          = _UxGT("Purge 210C");
  LSTR MSG_MAINTENANCE_PURGE_220          = _UxGT("Purge 220C");
  LSTR MSG_MAINTENANCE_PURGE_230          = _UxGT("Purge 230C");
  LSTR MSG_MAINTENANCE_PURGE_240          = _UxGT("Purge 240C");
  LSTR MSG_MAINTENANCE_PURGE_250          = _UxGT("Purge 250C");
  LSTR MSG_MAINTENANCE_PRE_LEVEL          = _UxGT("Pre-level");
