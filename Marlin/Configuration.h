...
// @snfx
#define STRING_CONFIG_H_AUTHOR "(snfx, Ender-5 Pro)" // Who made the changes.
...
// @snfx
#define CUSTOM_MACHINE_NAME "snfx E5-pro 4.2.7"
 ...
 */
// @snfx 4.2.7 motherboard uses TMC2225 drivers
 ...
 */
//#define PSU_CONTROL
// @snfx just for display in the board info menu
#define PSU_NAME "LRS-350-24+F8"
 ...
 */
// @snfx slice 300C thermistor; see above doc
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
// @snfx really shouldn't get higher than that with ddx v2; beware of jerk value as well
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 5000 }

// @snfx custom max limits because I know that going to high will just break the steppers (had issues already)
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  // @snfx
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 200, 7000 } // ...or, set your own edit limits
#endif
 ...
 */
// @snfx all known to work correctly, and print decently fast with ddx v2
...
// @snfx: without that, leveling is lost after homing
//        see https://marlinfw.org/docs/gcode/G028.html
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // @snfx bed is really messed up, so .5mm should be better
   ...
   */
  // @snfx maybe that will save me some time; hoping it's available after mesh leveling
  //       see https://marlinfw.org/docs/gcode/G026.html for settings underneath
  #define G26_MESH_VALIDATION
  #if ENABLED(G26_MESH_VALIDATION)
    // @snfx .5mm nozzle with ddx v2
    #define MESH_TEST_NOZZLE_SIZE    0.5  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.2  // (mm) Default layer height for G26.
    // @snfx assume sunlu white PLA
    ...
    // @snfx with ddx v2, this must be very low (this is a MULTIPLIER; read the specs)
...
#define LCD_BED_TRAMMING
  ...
  // @snfx so we get a better glance
 ...
 */
// @snfx required for PRINTCOUNTER
...
//
// @snfx now that's a cool feature
#define PREHEAT_1_LABEL        "PLA"
#define PREHEAT_1_TEMP_HOTEND  190  // C
#define PREHEAT_1_TEMP_BED     60   // C
#define PREHEAT_1_TEMP_CHAMBER 35   // C
 ...
 */
// @snfx could be cool, even though I track that myself
#define PRINTCOUNTER
...
// @snfx A440; sounds much better than original
...
//
// @snfx this is enabled by default in the example ender 5 pro config, so better leave it I guess.
//       Also extra if over there, so reported here.
//       See https://github.com/MarlinFirmware/Configurations/blob/import-2.1.x/config/examples/Creality/Ender-5%20Pro/CrealityV427/Configuration.h#LL2996C9
...
// @snfx required by the creality board, otherwise compilation errors
#define FAN_SOFT_PWM
